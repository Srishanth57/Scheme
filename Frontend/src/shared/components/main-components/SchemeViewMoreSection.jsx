...
export function SchemeViewMoreSection({ scheme, currentLang }) {
    ...
    <Dialog>
      ...
      <DialogContent className="w-[98vw] max-w-6xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="space-y-4 p-1 text-sm text-muted-foreground">
            {/* Main Details Panel */}
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg p-5">
              <div className="space-y-4">
                ...
                {scheme.benefits && (
                  ...
                  >
                    <div className="bg-emerald-50 dark:bg-emerald-950/30 px-3 py-2 rounded-md border border-emerald-200 dark:border-emerald-800 font-semibold w-fit">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg p-5">
              <div className="space-y-4">
                {scheme.ageGroup && (
                  <InfoRow
                    icon={Calendar}
                    label={currentLang === "ml" ? "പ്രായപരിധി:" : "Age Group:"}
                  >
            ...
            {/* Links and Application Process Panel */}
